...
// Ubah nilai di sini sesuai hardware Anda.
// ================================================================

// ----------------------------------------------------------------
// PIN GPIO ESP32
// ----------------------------------------------------------------
#define PH_ANALOG_PIN       34    // ADC1_CH6 — input-only
#define FLOW_SENSOR_PIN     16    // Digital interrupt — YF-S201
#define TRIG_PIN            26    // HC-SR04 Trigger
#define ECHO_PIN            27    // HC-SR04 Echo
// LCD I2C: SDA=GPIO21, SCL=GPIO22 (default Wire ESP32)
...
#define LCD_PAGE_INTERVAL         2500UL    // Ganti halaman: 2.5 detik
...
#define SENSOR_OFFSET_CM    0.0f    // Offset posisi sensor dari atas (cm)
...
#define PH_ADC_MAX          4095  // Resolusi 12-bit ESP32
// Kalibrasi — ukur tegangan saat sensor dicelup ke buffer pH 7.0
...
// KONFIGURASI HC-SR04
// ----------------------------------------------------------------
#define ULTRASONIC_AVG_SIZE   5       // Moving average window
