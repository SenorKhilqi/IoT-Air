...
// ================================================================
// lcd_display.cpp — LCD I2C dengan 3 Halaman Rotasi
// Halaman 0: pH + Flow
// Halaman 1: Level + WiFi
// Halaman 2: Supabase Status
// ================================================================
...
// ---- Private: render satu halaman ke LCD ----
...
void begin() {
  ...
  Serial.print(F("[LCD] Siap. Addr=0x"));
